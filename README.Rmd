...
*Over the past six years, I kept building the same data analytics pipelines from scratch for every disease preparedness and outbreak response activity I engaged in to support MoH containment of disease...*

*So I built **EpiDataLab** which is a free open source workspace with reproducible R/Python pipelines designed specifically for field disease surveillance data: cleaning, triangulating, and analyzing...*
